---
slug: difference-between-adapter-pattern-and-facade-patt
title: Difference between adapter pattern and facade pattern
...
originalAnchor: '#5-difference-between-adapter-pattern-and-facade-pattern'
